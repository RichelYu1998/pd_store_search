...
<header id="top">
    ...
    <div id="top_input" class="lf">
        ...
        <div class="seek" tabindex="-1">
            <div class="actived"><span>分类搜索</span> <img src="/images/server/images/portal/header/header_normal.png"
                                                        alt=""/></div>
        ...
        <a href="javascript:void(0);" class="rt" onclick="search1()"><img id="search"
                                                                          src="/images/server/images/portal/header/search.png"
                                                                          alt="搜索"/></a>
    </div>
    <div class="rt">
        <ul class="lf" id="iul">
            ...
            <li><a href="/order/toMyOrder.html" title="我的订单"> <img class="order"
                                                                   src="/images/server/images/portal/header/order.png"
                                                                   alt=""/>
            </a><b>|</b></li>
            <li><a href="/cart/toCart.html" title="我的购物车"> <img class="shopcar"
                                                                src="/images/server/images/portal/header/shop_car.png"
                                                                alt=""/>
            </a><b>|</b></li>
            <li></li>
        </ul>
